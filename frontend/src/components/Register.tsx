...
const Register = () => {
  ...
  const validationSchema = Yup.object({
    full_name: Yup.string().min(3, 'Too short!').required('Full name is required'),
  ...
  <Form>
    ...
    <div className="form-outline mb-4">
      <label htmlFor="full_name" className="form-label" style={{ fontSize: '16px', fontWeight: 'bold' }}>
        Full name
      </label>
      <Field type="text" id="full_name" name="full_name" className="form-control" />
    ...
    <div className="form-outline mb-3">
      ...
      <div className="input-group position-relative">
        <Field type={showPassword ? 'text' : 'password'} id="password" name="password" className="form-control" />
        <div
    ...
    <div className="text-center pt-1 mb-5 pb-1">
      ...
      <div>
        <Link
          className="btn btn-link btn-block fa-lg gradient-custom-3"
          style={{ textDecoration: 'none', color: '#0A909F' }}
          to="/login"
        >
          Login Instead!
        </Link>
